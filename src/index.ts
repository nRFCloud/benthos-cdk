...
import {Architecture, Code, Function, FunctionProps, Runtime, LayerVersion} from "aws-cdk-lib/aws-lambda";
...
export class BenthosLambda extends Function {
    ...
    constructor(scope: Construct, id: string, props: BenthoLambdaProps) {
        super(scope, id, {
            ...
            code: BenthosLambda.getBenthosArtifactAsset(props.ghRepo ?? DEFAULT_GH_REPO, props.version ?? DEFAULT_VERSION, DEFAULT_ARCH),
